[android-generic-adapter](../../index.md) / [com.sophoun.generic.adapter](../index.md) / [BaseRecyclerAdapter](index.md) / [addOnBottomReachedListener](./add-on-bottom-reached-listener.md)
