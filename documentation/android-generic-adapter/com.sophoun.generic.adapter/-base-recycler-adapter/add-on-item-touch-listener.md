[android-generic-adapter](../../index.md) / [com.sophoun.generic.adapter](../index.md) / [BaseRecyclerAdapter](index.md) / [addOnItemTouchListener](./add-on-item-touch-listener.md)
